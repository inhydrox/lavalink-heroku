...
class lavalinkserver:
    ...
    def __init__(self):
        self . download_command  =  "curl -s https://ci.fredboat.com/repository/download/Lavalink_Build/8110:id/Lavalink.jar?guest=1 | grep browser_download_url | cut -d ' \" ' -f 4 | wget -qi - "
